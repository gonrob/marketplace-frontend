...
const T = {
  es:{flag:'🇦🇷',n:'ES',tag:'Hablá con argentinos reales. Viví la cultura.',sub:'Mate · Truco · Fútbol · Dulce de leche',buscar:'Buscar anfitriones',inscribirse:'Inscribirse (Anfitriones & Viajeros)',como:'¿Cómo funciona?',p1t:'Elegí un anfitrión',p1d:'Filtrá por interés, habilidad o disponibilidad',p2t:'El primer contacto es GRATIS',p2d:'A partir del segundo, solo USD 0.50',p3t:'¡Conectate!',p3d:'Después del primer contacto, son libres de continuar como quieran',entrar:'Entrar',perfil:'Mi perfil',comp:'Compartir app',cont:'Contacto',consejos:'Consejos de viaje',consejossub:'Dinero, transporte, seguridad y más',mate:'Mate',truco:'Truco',futbol:'Fútbol',dulce:'Dulce de leche',lunfardo:'Aprendé el lunfardo'},
  ...
  pt:{flag:'🇧🇷',n:'PT',tag:'Fale com argentinos reais. Viva a cultura.',sub:'Mate · Truco · Futebol · Doce de leite',buscar:'Encontrar anfitriões',inscribirse:'Cadastrar (Anfitriões & Viajantes)',como:'Como funciona?',p1t:'Escolha um anfitrião',p1d:'Filtre por interesse ou disponibilidade',p2t:'Primeiro contato é GRÁTIS',p2d:'A partir do segundo, apenas USD 0.50',p3t:'Conecte-se!',p3d:'Após o primeiro contato, são livres para continuar',entrar:'Entrar',perfil:'Meu perfil',comp:'Compartilhar',cont:'Contato',consejos:'Dicas de viagem',consejossub:'Dinheiro, transporte, segurança e mais',mate:'Mate',truco:'Truco',futbol:'Futebol',dulce:'Doce de leite',lunfardo:'Aprenda o lunfardo'},
  ...
  it:{flag:'🇮🇹',n:'IT',tag:'Parla con veri argentini. Vivi la cultura.',sub:'Mate · Truco · Calcio · Dulce de leche',buscar:'Trova host',inscribirse:'Iscriviti (Host & Viaggiatori)',como:'Come funziona?',p1t:'Scegli un host',p1d:'Filtra per interesse o disponibilità',p2t:'Primo contatto GRATUITO',p2d:'Dal secondo, solo USD 0.50',p3t:'Connettiti!',p3d:'Dopo il primo contatto siete liberi',entrar:'Accedi',perfil:'Il mio profilo',comp:'Condividi',cont:'Contatto',consejos:'Consigli di viaggio',consejossub:'Denaro, trasporti, sicurezza e altro',mate:'Mate',truco:'Truco',futbol:'Calcio',dulce:'Dulce de leche',lunfardo:'Impara il lunfardo'},
  ...
  zh:{flag:'🇨🇳',n:'ZH',tag:'与真正的阿根廷人交流。体验文化。',sub:'马黛茶·特鲁科·足球·牛奶焦糖',buscar:'寻找主人',inscribirse:'注册',como:'怎么运作？',p1t:'选择主人',p1d:'按兴趣或可用性筛选',p2t:'首次联系免费',p2d:'从第二次起，仅需USD 0.50',p3t:'联系！',p3d:'第一次联系后可以自由继续',entrar:'登录',perfil:'我的资料',comp:'分享',cont:'联系',consejos:'旅行贴士',consejossub:'金钱、交通、安全等',mate:'马黛茶',truco:'特鲁科',futbol:'足球',dulce:'牛奶焦糖',lunfardo:'学习阿根廷俚语'},
