...
const T = {
  ...
  en:{flag:'🇬🇧',n:'EN',tag:'Connect with real Argentinians. Live the culture.',sub:'Mate · Truco · Football · Dulce de leche',buscar:'Find hosts',inscribirse:'Sign up (Hosts & Travelers)',como:'How does it work?',p1t:'Choose a host',p1d:'Filter by interest, skill or availability',p2t:'🎁 We gift you a welcome chat',p2d:'Meet your first Argentine for free. More hosts? Only USD 0.50 each',p3t:'Connect!',p3d:'After first contact, you are free to continue however you want',entrar:'Log in',perfil:'My profile',gratis:'Your first contact is FREE',buscarmas:'🔍 Find more hosts',gratissub:'Then only USD 0.50 per host',destacados:'Available hosts now',vertodos:'View all hosts →',comp:'Share app',cont:'Contact',consejos:'Travel tips',mapa:'View host map',eventos:'Events',descargar:'📲 Download app',consejossub:'Money, transport, safety and more',mate:'Mate',truco:'Truco',futbol:'Football',dulce:'Dulce de leche',lunfardo:'Learn Argentine slang'},
