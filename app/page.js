...
const T = {
  es:{flag:'🇦🇷',n:'ES',tag:'Conectá con argentinos reales. Viví la cultura.',sub:'Mate · Truco · Fútbol · Dulce de leche',buscar:'Buscar anfitriones',inscribirse:'Inscribirse (Anfitriones & Viajeros)',como:'¿Cómo funciona?',p1t:'Elegí un anfitrión',p1d:'Filtrá por interés, habilidad o disponibilidad',p2t:'El primer contacto es GRATIS',p2d:'A partir del segundo, solo USD 0.50',p3t:'¡Conectate!',p3d:'Después del primer contacto, son libres de continuar como quieran',entrar:'Entrar',perfil:'Mi perfil',comp:'Compartir app',cont:'Contacto',consejos:'Consejos de viaje',mapa:'Ver mapa de anfitriones',consejossub:'Dinero, transporte, seguridad y más',mate:'Mate',truco:'Truco',futbol:'Fútbol',dulce:'Dulce de leche',lunfardo:'Aprendé el lunfardo'},
  en:{flag:'🇬🇧',n:'EN',tag:'Connect with real Argentinians. Live the culture.',sub:'Mate · Truco · Football · Dulce de leche',buscar:'Find hosts',inscribirse:'Sign up (Hosts & Travelers)',como:'How does it work?',p1t:'Choose a host',p1d:'Filter by interest, skill or availability',p2t:'First contact is FREE',p2d:'From the second one, only USD 0.50',p3t:'Connect!',p3d:'After first contact, you are free to continue however you want',entrar:'Log in',perfil:'My profile',comp:'Share app',cont:'Contact',consejos:'Travel tips',mapa:'View host map',consejossub:'Money, transport, safety and more',mate:'Mate',truco:'Truco',futbol:'Football',dulce:'Dulce de leche',lunfardo:'Learn Argentine slang'},
  pt:{flag:'🇧🇷',n:'PT',tag:'Conecte com argentinos reais. Viva a cultura.',sub:'Mate · Truco · Futebol · Doce de leite',buscar:'Encontrar anfitriões',inscribirse:'Cadastrar (Anfitriões & Viajantes)',como:'Como funciona?',p1t:'Escolha um anfitrião',p1d:'Filtre por interesse ou disponibilidade',p2t:'Primeiro contato é GRÁTIS',p2d:'A partir do segundo, apenas USD 0.50',p3t:'Conecte-se!',p3d:'Após o primeiro contato, são livres para continuar',entrar:'Entrar',perfil:'Meu perfil',comp:'Compartilhar',cont:'Contato',consejos:'Dicas de viagem',mapa:'Ver mapa de anfitriões',consejossub:'Dinheiro, transporte, segurança e mais',mate:'Mate',truco:'Truco',futbol:'Futebol',dulce:'Doce de leite',lunfardo:'Aprenda o lunfardo'},
  fr:{flag:'🇫🇷',n:'FR',tag:'Connectez avec de vrais Argentins. Vivez la culture.',sub:'Maté · Truco · Football · Dulce de leche',buscar:'Trouver des hôtes',inscribirse:"S'inscrire (Hôtes & Voyageurs)",como:'Comment ça marche?',p1t:'Choisissez un hôte',p1d:'Filtrez par intérêt ou disponibilité',p2t:'Premier contact GRATUIT',p2d:'À partir du deuxième, seulement USD 0.50',p3t:'Connectez-vous!',p3d:'Après le premier contact, vous êtes libres',entrar:'Se connecter',perfil:'Mon profil',comp:'Partager',cont:'Contact',consejos:'Conseils de voyage',mapa:'Voir la carte des hôtes',consejossub:'Argent, transport, sécurité et plus',mate:'Maté',truco:'Truco',futbol:'Football',dulce:'Dulce de leche',lunfardo:'Apprenez le lunfardo'},
  it:{flag:'🇮🇹',n:'IT',tag:'Connettiti con veri argentini. Vivi la cultura.',sub:'Mate · Truco · Calcio · Dulce de leche',buscar:'Trova host',inscribirse:'Iscriviti (Host & Viaggiatori)',como:'Come funziona?',p1t:'Scegli un host',p1d:'Filtra per interesse o disponibilità',p2t:'Primo contatto GRATUITO',p2d:'Dal secondo, solo USD 0.50',p3t:'Connettiti!',p3d:'Dopo il primo contatto siete liberi',entrar:'Accedi',perfil:'Il mio profilo',comp:'Condividi',cont:'Contatto',consejos:'Consigli di viaggio',mapa:'Vedi mappa degli host',consejossub:'Denaro, trasporti, sicurezza e altro',mate:'Mate',truco:'Truco',futbol:'Calcio',dulce:'Dulce de leche',lunfardo:'Impara il lunfardo'},
  de:{flag:'🇩🇪',n:'DE',tag:'Verbinde dich mit echten Argentiniern. Erlebe die Kultur.',sub:'Mate · Truco · Fußball · Dulce de leche',buscar:'Gastgeber finden',inscribirse:'Registrieren (Gastgeber & Reisende)',como:'Wie funktioniert es?',p1t:'Wähle einen Gastgeber',p1d:'Filtere nach Interesse oder Verfügbarkeit',p2t:'Erster Kontakt KOSTENLOS',p2d:'Ab dem zweiten nur USD 0.50',p3t:'Verbinde dich!',p3d:'Nach dem ersten Kontakt könnt ihr weitermachen',entrar:'Anmelden',perfil:'Mein Profil',comp:'Teilen',cont:'Kontakt',consejos:'Reisetipps',mapa:'Gastgeberkarte anzeigen',consejossub:'Geld, Transport, Sicherheit und mehr',mate:'Mate',truco:'Truco',futbol:'Fußball',dulce:'Dulce de leche',lunfardo:'Lerne Lunfardo'},
  zh:{flag:'🇨🇳',n:'ZH',tag:'与真正的阿根廷人联系。体验文化。',sub:'马黛茶·特鲁科·足球·牛奶焦糖',buscar:'寻找主人',inscribirse:'注册',como:'怎么运作？',p1t:'选择主人',p1d:'按兴趣或可用性筛选',p2t:'首次联系免费',p2d:'从第二次起，仅需USD 0.50',p3t:'联系！',p3d:'第一次联系后可以自由继续',entrar:'登录',perfil:'我的资料',comp:'分享',cont:'联系',consejos:'旅行贴士',mapa:'查看房东地图',consejossub:'金钱、交通、安全等',mate:'马黛茶',truco:'特鲁科',futbol:'足球',dulce:'牛奶焦糖',lunfardo:'学习阿根廷俚语'},
  ru:{flag:'🇷🇺',n:'RU',tag:'Общайтесь с настоящими аргентинцами.',sub:'Мате·Труко·Футбол·Дульсе де лече',buscar:'Найти хозяина',inscribirse:'Зарегистрироваться',como:'Как это работает?',p1t:'Выберите хозяина',p1d:'Фильтр по интересам',p2t:'Первый контакт БЕСПЛАТНО',p2d:'Со второго только USD 0.50',p3t:'Свяжитесь!',p3d:'После первого контакта вы свободны',entrar:'Войти',perfil:'Мой профиль',comp:'Поделиться',cont:'Контакт',consejos:'Советы путешественникам',mapa:'Смотреть карту хозяев',consejossub:'Деньги, транспорт, безопасность и другое',mate:'Мате',truco:'Труко',futbol:'Футбол',dulce:'Дульсе де лече',lunfardo:'Учите лунфардо'},
};
