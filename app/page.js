...
const T = {
  es:{flag:'🇦🇷',n:'ES',tag:'Hablá con argentinos reales. Viví la cultura.',sub:'Mate · Truco · Fútbol · Dulce de leche',buscar:'Buscar anfitriones',inscribirse:'Inscribirse (Anfitriones & Viajeros)',como:'¿Cómo funciona?',p1t:'Elegí un anfitrión',p1d:'Filtrá por interés, habilidad o disponibilidad',p2t:'Pagá el primer contacto',p2d:'Pago seguro con Stripe',p3t:'¡Conectate!',p3d:'Después del primer contacto, son libres de continuar como quieran',entrar:'Entrar',perfil:'Mi perfil',reg:'Registrarse',viaje:'¿Viajás a Argentina?',mpd:'Creá tu cuenta de Mercado Pago gratis para pagar en Argentina',mpb:'Crear cuenta Mercado Pago',comp:'Compartir app',cont:'Contacto'},
  en:{flag:'🇬🇧',n:'EN',tag:'Talk with real Argentinians. Live the culture.',sub:'Mate · Truco · Football · Dulce de leche',buscar:'Find hosts',inscribirse:'Sign up (Hosts & Travelers)',como:'How does it work?',p1t:'Choose a host',p1d:'Filter by interest, skill or availability',p2t:'Pay for first contact',p2d:'Secure payment with Stripe',p3t:'Connect!',p3d:'After first contact, you are free to continue however you want',entrar:'Log in',perfil:'My profile',reg:'Sign up',viaje:'Traveling to Argentina?',mpd:'Create your free Mercado Pago account to pay in Argentina',mpb:'Create Mercado Pago account',comp:'Share app',cont:'Contact'},
  pt:{flag:'🇧🇷',n:'PT',tag:'Fale com argentinos reais. Viva a cultura.',sub:'Mate · Truco · Futebol · Doce de leite',buscar:'Encontrar anfitriões',inscribirse:'Cadastrar (Anfitriões & Viajantes)',como:'Como funciona?',p1t:'Escolha um anfitrião',p1d:'Filtre por interesse, habilidade ou disponibilidade',p2t:'Pague o primeiro contato',p2d:'Pagamento seguro com Stripe',p3t:'Conecte-se!',p3d:'Após o primeiro contato, são livres para continuar como quiserem',entrar:'Entrar',perfil:'Meu perfil',reg:'Cadastrar',viaje:'Viajando para Argentina?',mpd:'Crie sua conta Mercado Pago grátis para pagar na Argentina',mpb:'Criar conta Mercado Pago',comp:'Compartilhar',cont:'Contato'},
  fr:{flag:'🇫🇷',n:'FR',tag:'Parlez avec de vrais Argentins. Vivez la culture.',sub:'Maté · Truco · Football · Dulce de leche',buscar:'Trouver des hôtes',inscribirse:"S'inscrire (Hôtes & Voyageurs)",como:'Comment ça marche?',p1t:'Choisissez un hôte',p1d:'Filtrez par intérêt, compétence ou disponibilité',p2t:'Payez le premier contact',p2d:'Paiement sécurisé avec Stripe',p3t:'Connectez-vous!',p3d:'Après le premier contact, vous êtes libres de continuer',entrar:'Se connecter',perfil:'Mon profil',reg:"S'inscrire",viaje:'Vous voyagez en Argentine?',mpd:'Créez votre compte Mercado Pago gratuit',mpb:'Créer un compte Mercado Pago',comp:'Partager',cont:'Contact'},
  it:{flag:'🇮🇹',n:'IT',tag:'Parla con veri argentini. Vivi la cultura.',sub:'Mate · Truco · Calcio · Dulce de leche',buscar:'Trova host',inscribirse:'Iscriviti (Host & Viaggiatori)',como:'Come funziona?',p1t:'Scegli un host',p1d:'Filtra per interesse, abilità o disponibilità',p2t:'Paga il primo contatto',p2d:'Pagamento sicuro con Stripe',p3t:'Connettiti!',p3d:'Dopo il primo contatto, siete liberi di continuare',entrar:'Accedi',perfil:'Il mio profilo',reg:'Iscriviti',viaje:'Viaggi in Argentina?',mpd:'Crea il tuo account Mercado Pago gratuito',mpb:'Crea account Mercado Pago',comp:'Condividi',cont:'Contatto'},
  de:{flag:'🇩🇪',n:'DE',tag:'Sprich mit echten Argentiniern. Erlebe die Kultur.',sub:'Mate · Truco · Fußball · Dulce de leche',buscar:'Gastgeber finden',inscribirse:'Registrieren (Gastgeber & Reisende)',como:'Wie funktioniert es?',p1t:'Wähle einen Gastgeber',p1d:'Filtere nach Interesse, Fähigkeit oder Verfügbarkeit',p2t:'Zahle den ersten Kontakt',p2d:'Sichere Zahlung mit Stripe',p3t:'Verbinde dich!',p3d:'Nach dem ersten Kontakt könnt ihr weitermachen',entrar:'Anmelden',perfil:'Mein Profil',reg:'Registrieren',viaje:'Reist du nach Argentinien?',mpd:'Erstelle dein kostenloses Mercado Pago Konto',mpb:'Mercado Pago Konto erstellen',comp:'Teilen',cont:'Kontakt'},
  zh:{flag:'🇨🇳',n:'ZH',tag:'与真正的阿根廷人交流。体验文化。',sub:'马黛茶·特鲁科·足球·牛奶焦糖',buscar:'寻找主人',inscribirse:'注册（主人和旅行者）',como:'怎么运作？',p1t:'选择主人',p1d:'按兴趣、技能或可用性筛选',p2t:'支付第一次联系费用',p2d:'通过Stripe安全支付',p3t:'联系！',p3d:'第一次联系后可以自由继续',entrar:'登录',perfil:'我的资料',reg:'注册',viaje:'去阿根廷旅行？',mpd:'创建免费的Mercado Pago账户',mpb:'创建Mercado Pago账户',comp:'分享',cont:'联系'},
  ru:{flag:'🇷🇺',n:'RU',tag:'Общайтесь с настоящими аргентинцами.',sub:'Мате·Труко·Футбол·Дульсе де лече',buscar:'Найти хозяина',inscribirse:'Зарегистрироваться',como:'Как это работает?',p1t:'Выберите хозяина',p1d:'Фильтр по интересам и навыкам',p2t:'Оплатите первый контакт',p2d:'Безопасная оплата через Stripe',p3t:'Свяжитесь!',p3d:'После первого контакта вы свободны',entrar:'Войти',perfil:'Мой профиль',reg:'Зарегистрироваться',viaje:'Путешествуете в Аргентину?',mpd:'Создайте бесплатный аккаунт Mercado Pago',mpb:'Создать аккаунт Mercado Pago',comp:'Поделиться',cont:'Контакт'},
};
      ...
      <nav className="nav">
        ...
        <div className="nav-links">
          ...
          {loggedIn
            ...
            : <><Link href="/login">{t.entrar}</Link><Link href="/register">{t.reg}</Link></>
          }
        </div>
      </nav>
