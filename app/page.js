    ...
    <>
      ...
      <div style={{ maxWidth: 480, margin: '-30px auto 0', padding: '0 20px 40px' }}>
        ...
        <div className="card" style={{ background: '#009ee3', textAlign: 'center' }}>
          ...
          <div style={{ color: 'white', fontWeight: 700, fontSize: 16, marginBottom: 6 }}>{t.viajando}</div>
          <div style={{ color: 'rgba(255,255,255,0.85)', fontSize: 13, marginBottom: 16 }}>{t.mpDesc}</div>
          <a href="https://www.mercadopago.com.ar/hub/registration/start" target="_blank" rel="noopener noreferrer">
            <button style={{ background: 'white', color: '#009ee3', border: 'none', borderRadius: 10, padding: '12px 24px', fontWeight: 700, fontSize: 14, cursor: 'pointer', width: 'auto' }}>{t.mpBtn}</button>
          </a>
        </div>

        <div style={{ textAlign: 'center', padding: '20px 0 40px', display: 'flex', gap: 20, justifyContent: 'center', flexWrap: 'wrap' }}>
          <Link href="/compartir" style={{ color: '#003DA5', fontSize: 14, textDecoration: 'none' }}>{t.compartir}</Link>
          <Link href="/contacto" style={{ color: '#003DA5', fontSize: 14, textDecoration: 'none' }}>{t.contacto}</Link>
          <Link href="/explorar" style={{ color: '#003DA5', fontSize: 14, textDecoration: 'none' }}>{t.verAnf}</Link>
        </div>
      </div>
    </>
  );
