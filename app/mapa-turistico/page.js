...
const DESTINOS = [
  ...
  { id:'ushuaia', nombre:'Ushuaia', lat:-54.8019, lng:-68.3029, emoji:'🐧', desc:{es:'El fin del mundo. Pingüinos, glaciares y el Canal Beagle. La ciudad más austral del planeta.',en:'The end of the world. Penguins, glaciers and the Beagle Channel.'}, epoca:{es:'Nov-mar: días largos. Jun-ago: nieve y ski.',en:'Nov-Mar: long days. Jun-Aug: snow and skiing.'}, ciudades:['Ushuaia'] },
  { id:'elcalafate', nombre:'El Calafate', lat:-50.3382, lng:-72.2648, emoji:'🏔️', desc:{es:'El Glaciar Perito Moreno, uno de los pocos glaciares del mundo que avanza. Espectacular.',en:'The Perito Moreno Glacier, one of the few advancing glaciers in the world. Spectacular.'}, epoca:{es:'Oct-abr para ver el glaciar con buen clima.',en:'Oct-Apr for the glacier in good weather.'}, ciudades:['El Calafate','El Chaltén'] },
  { id:'elchalten', nombre:'El Chaltén', lat:-49.3314, lng:-72.8868, emoji:'🧗', desc:{es:'La capital del trekking argentino. El Fitz Roy y el Cerro Torre son destinos de montaña únicos en el mundo.',en:'Argentina trekking capital. Fitz Roy and Cerro Torre are unique mountain destinations.'}, epoca:{es:'Nov-mar: mejor clima para trekking.',en:'Nov-Mar: best weather for trekking.'}, ciudades:['El Chaltén'] },
  { id:'puertomadryn', nombre:'Puerto Madryn', lat:-42.7682, lng:-65.0385, emoji:'🐋', desc:{es:'Avistaje de ballenas jorobadas y orcas. La Península Valdés es Patrimonio de la UNESCO.',en:'Humpback whale and orca watching. Valdés Peninsula is a UNESCO World Heritage site.'}, epoca:{es:'Jun-dic para ballenas. Sep-oct pico de temporada.',en:'Jun-Dec for whales. Sep-Oct peak season.'}, ciudades:['Puerto Madryn','Trelew'] },
  { id:'tilcara', nombre:'Tilcara', lat:-23.5772, lng:-65.3970, emoji:'🏺', desc:{es:'Pueblo mágico en la Quebrada de Humahuaca, declarada Patrimonio de la Humanidad. Pucará y carnaval únicos.',en:'Magical village in the Humahuaca Gorge, UNESCO World Heritage. Unique Pucará and carnival.'}, epoca:{es:'Abr-oct temporada seca. Carnaval en febrero.',en:'Apr-Oct dry season. Carnival in February.'}, ciudades:['Tilcara','Jujuy'] },
  { id:'rosario', nombre:'Rosario', lat:-32.9442, lng:-60.6505, emoji:'🏅', desc:{es:'Cuna de la bandera argentina y de Lionel Messi. Ciudad cultural con gran movimiento gastronómico.',en:'Birthplace of the Argentine flag and Lionel Messi. Cultural city with great gastronomy.'}, epoca:{es:'Todo el año. Primavera y otoño ideales.',en:'Year-round. Spring and autumn ideal.'}, ciudades:['Rosario'] },
  { id:'sanmartin', nombre:'San Martín de los Andes', lat:-40.1573, lng:-71.3527, emoji:'🌲', desc:{es:'Villa de montaña rodeada de lagos y bosques de araucarias. Más tranquila que Bariloche.',en:'Mountain village surrounded by lakes and araucaria forests. More peaceful than Bariloche.'}, epoca:{es:'Dic-mar para verano. Jun-sep para nieve.',en:'Dec-Mar for summer. Jun-Sep for snow.'}, ciudades:['San Martín de los Andes'] },
  { id:'lasleñas', nombre:'Las Leñas', lat:-35.1500, lng:-70.0667, emoji:'🎿', desc:{es:'El mejor centro de ski de Argentina y uno de los mejores de Sudamérica. Nieve increíble.',en:'The best ski resort in Argentina and one of the best in South America. Incredible snow.'}, epoca:{es:'Jun-sep temporada de ski.',en:'Jun-Sep ski season.'}, ciudades:['Malargüe','Mendoza'] },
  { id:'elpalmar', nombre:'El Palmar', lat:-31.8667, lng:-58.2833, emoji:'🌴', desc:{es:'Parque Nacional con palmeras yatay de hasta 800 años. Entre Ríos escondido y mágico.',en:'National Park with up to 800-year-old yatay palms. Hidden and magical Entre Ríos.'}, epoca:{es:'Todo el año. Primavera y otoño ideales.',en:'Year-round. Spring and autumn ideal.'}, ciudades:['Colón','Concordia'] },
  { id:'ischigualasto', nombre:'Valle de la Luna', lat:-29.9000, lng:-67.9167, emoji:'🌑', desc:{es:'Ischigualasto, el Valle de la Luna. Formaciones rocosas lunares y dinosaurios. San Juan imperdible.',en:'Ischigualasto, the Valley of the Moon. Lunar rock formations and dinosaurs. Must-see San Juan.'}, epoca:{es:'Abr-oct para evitar calor extremo.',en:'Apr-Oct to avoid extreme heat.'}, ciudades:['San Juan'] },
  { id:'misiones', nombre:'Misiones', lat:-27.3671, lng:-55.8968, emoji:'🦜', desc:{es:'Selva misionera con tucanes, loros y monos. Las Ruinas Jesuíticas de San Ignacio son únicas.',en:'Misiones jungle with toucans, parrots and monkeys. San Ignacio Jesuit Ruins are unique.'}, epoca:{es:'Abr-oct clima más fresco y seco.',en:'Apr-Oct cooler and drier weather.'}, ciudades:['Posadas','Puerto Iguazú'] },
  { id:'merlo', nombre:'Merlo', lat:-32.3500, lng:-65.0167, emoji:'☀️', desc:{es:'El microclima más benigno de Argentina. Sierras de San Luis perfectas para descanso y ecoturismo.',en:'Argentina most benign microclimate. San Luis hills perfect for rest and ecotourism.'}, epoca:{es:'Todo el año gracias a su microclima especial.',en:'Year-round thanks to its special microclimate.'}, ciudades:['Merlo','San Luis'] },
];
    ...
    window.initMapaTuristico = () => {
      ...
      DESTINOS.forEach(d => {
        const marker = new window.google.maps.Marker({
          ...
          map,
          title: d.nombre, label: { text: d.emoji, color: "#ffffff", fontSize: "10px", fontWeight: "bold" },
          icon: { path: window.google.maps.SymbolPath.CIRCLE, scale: 14, fillColor: '#74ACDF', fillOpacity: 0.9, strokeColor: '#fff', strokeWeight: 2 },
        });
        marker.addListener('click', () => {
          setSelected(prev => prev?.id === d.id ? null : d);
          markersRef.current.forEach(m => m.marker.setIcon({ path: window.google.maps.SymbolPath.CIRCLE, scale: 14, fillColor: '#74ACDF', fillOpacity: 0.9, strokeColor: '#fff', strokeWeight: 2 }));
          marker.setIcon({ path: window.google.maps.SymbolPath.CIRCLE, scale: 18, fillColor: '#F6B40E', fillOpacity: 1, strokeColor: '#fff', strokeWeight: 3 });
        });
