      ...
      <div className="container">
        ...
        <div className="card">
          ...
          <div style={{textAlign:'center',marginBottom:20}}>
            <div style={{width:72,height:72,borderRadius:'50%',background:'#EBF2FF',color:'#003DA5',display:'flex',alignItems:'center',justifyContent:'center',fontSize:28,fontWeight:700,margin:'0 auto 8px'}}>
        ...
        <div className="card">
          ...
          <div style={{display:'flex',alignItems:'center',gap:12}}>
            ...
            <span style={{fontSize:13,color:'#888'}}>{form.disponible ? 'Los clientes te pueden contactar' : 'No apareces en las busquedas'}</span>
          </div>
        </div>
