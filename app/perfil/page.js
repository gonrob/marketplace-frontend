...
const T = {
  es:{titulo:'Mi perfil',foto:'Toca para cambiar la foto',nombre:'Nombre completo',ciudad:'Ciudad',sobre:'Sobre vos',precio:'Precio por primer contacto',recibes:'Vos recibis',cobra:'Argentalk cobra 15%',consejo:'Se recomienda un precio bajo. Este pago es solo para el primer contacto. Una vez contactados, podes acordar otro precio fuera de la app.',bueno:'En que sos bueno?',disponible:'Disponibilidad',disponibleBtn:'Disponible ahora',noDisponible:'No disponible',guardar:'Guardar perfil',guardando:'Guardando...',baja:'Dar de baja mi cuenta',bajaPregunta:'Ya no queres usar Argentalk?',exito:'Perfil actualizado!',fotoOk:'Foto actualizada!',errorFoto:'Error al subir foto.',errorGuardar:'Error al guardar.'},
  en:{titulo:'My profile',foto:'Tap to change photo',nombre:'Full name',ciudad:'City',sobre:'About you',precio:'Price per first contact',recibes:'You receive',cobra:'Argentalk charges 15%',consejo:'We recommend a low price. This payment is only for the first contact. Once connected, you can agree on another price outside the app.',bueno:'What are you good at?',disponible:'Availability',disponibleBtn:'Available now',noDisponible:'Not available',guardar:'Save profile',guardando:'Saving...',baja:'Delete my account',bajaPregunta:'Do you want to leave Argentalk?',exito:'Profile updated!',fotoOk:'Photo updated!',errorFoto:'Error uploading photo.',errorGuardar:'Error saving.'},
  pt:{titulo:'Meu perfil',foto:'Toque para mudar a foto',nombre:'Nome completo',ciudad:'Cidade',sobre:'Sobre voce',precio:'Preco por primeiro contato',recibes:'Voce recebe',cobra:'Argentalk cobra 15%',consejo:'Recomendamos um preco baixo. Este pagamento e apenas para o primeiro contato. Uma vez conectados, podem acordar outro preco fora do app.',bueno:'No que voce e bom?',disponible:'Disponibilidade',disponibleBtn:'Disponivel agora',noDisponible:'Nao disponivel',guardar:'Salvar perfil',guardando:'Salvando...',baja:'Excluir minha conta',bajaPregunta:'Quer sair do Argentalk?',exito:'Perfil atualizado!',fotoOk:'Foto atualizada!',errorFoto:'Erro ao enviar foto.',errorGuardar:'Erro ao salvar.'},
  fr:{titulo:'Mon profil',foto:'Appuyer pour changer la photo',nombre:'Nom complet',ciudad:'Ville',sobre:'A propos de vous',precio:'Prix par premier contact',recibes:'Vous recevez',cobra:'Argentalk prend 15%',consejo:'Nous recommandons un prix bas. Ce paiement est uniquement pour le premier contact. Une fois connectes, vous pouvez convenir un autre prix en dehors de application.',bueno:'En quoi etes-vous bon?',disponible:'Disponibilite',disponibleBtn:'Disponible maintenant',noDisponible:'Non disponible',guardar:'Sauvegarder',guardando:'Sauvegarde...',baja:'Supprimer mon compte',bajaPregunta:'Voulez-vous quitter Argentalk?',exito:'Profil mis a jour!',fotoOk:'Photo mise a jour!',errorFoto:'Erreur photo.',errorGuardar:'Erreur sauvegarde.'},
  it:{titulo:'Il mio profilo',foto:'Tocca per cambiare foto',nombre:'Nome completo',ciudad:'Citta',sobre:'Su di te',precio:'Prezzo per primo contatto',recibes:'Ricevi',cobra:'Argentalk prende 15%',consejo:'Consigliamo un prezzo basso. Questo pagamento e solo per il primo contatto. Una volta connessi, potete concordare un altro prezzo fuori app.',bueno:'In cosa sei bravo?',disponible:'Disponibilita',disponibleBtn:'Disponibile ora',noDisponible:'Non disponibile',guardar:'Salva profilo',guardando:'Salvando...',baja:'Elimina il mio account',bajaPregunta:'Vuoi lasciare Argentalk?',exito:'Profilo aggiornato!',fotoOk:'Foto aggiornata!',errorFoto:'Errore foto.',errorGuardar:'Errore salvataggio.'},
  de:{titulo:'Mein Profil',foto:'Tippen um Foto zu aendern',nombre:'Vollstaendiger Name',ciudad:'Stadt',sobre:'Ueber dich',precio:'Preis fuer ersten Kontakt',recibes:'Du erhaeltst',cobra:'Argentalk nimmt 15%',consejo:'Wir empfehlen einen niedrigen Preis. Diese Zahlung ist nur fuer den ersten Kontakt. Danach koennen Sie ausserhalb der App einen anderen Preis vereinbaren.',bueno:'Worin bist du gut?',disponible:'Verfuegbarkeit',disponibleBtn:'Jetzt verfuegbar',noDisponible:'Nicht verfuegbar',guardar:'Profil speichern',guardando:'Speichern...',baja:'Konto loeschen',bajaPregunta:'Moechtest du Argentalk verlassen?',exito:'Profil aktualisiert!',fotoOk:'Foto aktualisiert!',errorFoto:'Fehler beim Hochladen.',errorGuardar:'Fehler beim Speichern.'},
  zh:{titulo:'我的资料',foto:'点击更换照片',nombre:'全名',ciudad:'城市',sobre:'关于你',precio:'首次联系价格',recibes:'你收到',cobra:'Argentalk收取15%',consejo:'建议设置低价格。此付款仅用于首次联系。联系后可在应用外商定其他价格。',bueno:'你擅长什么?',disponible:'可用性',disponibleBtn:'现在可用',noDisponible:'不可用',guardar:'保存资料',guardando:'保存中...',baja:'删除我的账户',bajaPregunta:'你想离开Argentalk吗?',exito:'资料已更新!',fotoOk:'照片已更新!',errorFoto:'上传照片出错。',errorGuardar:'保存出错。'},
  ru:{titulo:'Мой профиль',foto:'Нажмите для смены фото',nombre:'Полное имя',ciudad:'Город',sobre:'О себе',precio:'Цена за первый контакт',recibes:'Вы получаете',cobra:'Argentalk берет 15%',consejo:'Рекомендуем низкую цену. Этот платеж только за первый контакт. После связи договоритесь о другой цене вне приложения.',bueno:'В чем вы хороши?',disponible:'Доступность',disponibleBtn:'Доступен сейчас',noDisponible:'Недоступен',guardar:'Сохранить профиль',guardando:'Сохранение...',baja:'Удалить аккаунт',bajaPregunta:'Хотите покинуть Argentalk?',exito:'Профиль обновлен!',fotoOk:'Фото обновлено!',errorFoto:'Ошибка загрузки фото.',errorGuardar:'Ошибка сохранения.'},
};
