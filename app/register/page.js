            ...
            <>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                <button
                  ...
                  style={{ background: 'white', color: '#003DA5', border: '2px solid #003DA5', borderRadius: 12, padding: 20, textAlign: 'left', cursor: 'pointer' }}
                >
                ...
                <button
                  ...
                  style={{ background: 'white', color: '#F4A020', border: '2px solid #F4A020', borderRadius: 12, padding: 20, textAlign: 'left', cursor: 'pointer' }}
                >
                  <div style={{ fontSize: 28, marginBottom: 8 }}>🌍</div>
          ...
          {step === 2 && (
            <>
              ...
              <div className="form-group">
                ...
                <input placeholder="Tu apellido" value={form.apellido} onChange={e => set('apellido', e.target.value)} />
              </div>
              <div className="form-group">
                <label>Email</label>
              ...
              <div className="form-group">
                ...
                <input type="password" placeholder="Minimo 6 caracteres" value={form.password} onChange={e => set('password', e.target.value)} />
              </div>
              <div className="form-group">
              ...
              <div style={{ display: 'flex', gap: 10 }}>
                ...
                <button onClick={() => setStep(3)} style={{ flex: 2 }} disabled={!form.nombre || !form.email || !form.password}>Siguiente</button>
              </div>
            </>
          )}
          ...
          {step === 3 && (
            <>
              ...
              {role === 'seller' && (
                <>
                  <p style={{ fontSize: 14, color: '#666', marginBottom: 16 }}>
                    Elegí como vas a recibir tus pagos. Podes cambiar esto despues.
                  </p>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginBottom: 16 }}>
                    <button
                      onClick={() => set('metodoPago', 'mercadopago')}
                      style={{ background: form.metodoPago === 'mercadopago' ? '#009ee3' : 'white', color: form.metodoPago === 'mercadopago' ? 'white' : '#009ee3', border: '2px solid #009ee3', borderRadius: 12, padding: 16, textAlign: 'left', cursor: 'pointer' }}
                    >
                    ...
                    <button
                      onClick={() => set('metodoPago', 'banco')}
                      style={{ background: form.metodoPago === 'banco' ? '#003DA5' : 'white', color: form.metodoPago === 'banco' ? 'white' : '#003DA5', border: '2px solid #003DA5', borderRadius: 12, padding: 16, textAlign: 'left', cursor: 'pointer' }}
                    >
                  ...
                  {form.metodoPago === 'mercadopago' && (
                    <div className="form-group">
                      <label>Tu email o telefono de Mercado Pago</label>
              ...
              {role === 'buyer' && (
                <>
                  <p style={{ fontSize: 14, color: '#666', marginBottom: 16 }}>
                    Podes pagar con tarjeta internacional. Si viajás a Argentina, te ayudamos a crear una cuenta en Mercado Pago.
                  </p>
                  ...
                  <div style={{ background: '#e8f5ff', borderRadius: 12, padding: 16, marginBottom: 16, border: '1px solid #009ee3' }}>
                    ...
                    <div style={{ fontSize: 13, color: '#555' }}>Si viajás a Argentina, te enviamos instrucciones para crear tu cuenta gratis</div>
                    <input placeholder="tu@email.com (opcional)" value={form.cuentaPago} onChange={e => set('cuentaPago', e.target.value)} style={{ marginTop: 10, padding: '8px 12px', borderRadius: 8, border: '1px solid #ddd', width: '100%', fontSize: 13 }} />
                  </div>
                </>
              )}
              ...
              <div style={{ display: 'flex', gap: 10, marginTop: 8 }}>
                ...
                <button className="btn-orange" onClick={handleSubmit} disabled={loading || (role === 'seller' && !form.metodoPago)} style={{ flex: 2 }}>
