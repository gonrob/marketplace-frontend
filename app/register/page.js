...
const T = {
  es:{titulo:'Unete a Argentalk',soy:'Soy...',anfitrionTitulo:'Anfitrion argentino',anfitrionDesc:'Quiero compartir mi cultura y ganar dinero extra',viajeroTitulo:'Viajero / Extranjero',viajeroDesc:'Quiero conocer argentinos y la cultura — Gratis para registrarse',yaTenes:'Ya tenes cuenta?',entrar:'Entrar',tusDatos:'Tus datos',nombre:'Nombre',apellido:'Apellido',email:'Email',contrasena:'Contrasena',minimo:'Minimo 6 caracteres',telefono:'Telefono',ciudad:'Ciudad',ciudadPlaceholder:'Buenos Aires, Mendoza...',pais:'Pais de residencia',paisPlaceholder:'Espana, Italia, USA...',atras:'Atras',siguiente:'Siguiente',registrarGratis:'Registrarme gratis',creando:'Creando...',gratis:'El registro es gratis. Solo pagas cuando elegis un anfitrion.',cobrar:'Como queres cobrar?',mp:'Mercado Pago',mpDesc:'Recomendado para Argentina',banco:'Cuenta bancaria',bancoDesc:'CBU o alias',mpEmail:'Email o telefono de Mercado Pago',cbu:'CBU o alias',crearCuenta:'Crear cuenta',creandoCuenta:'Creando cuenta...',emailMsg:'Te hemos enviado un email de confirmacion. Puede que llegue a tu bandeja de spam.'},
  en:{titulo:'Join Argentalk',soy:'I am...',anfitrionTitulo:'Argentine host',anfitrionDesc:'I want to share my culture and earn extra money',viajeroTitulo:'Traveler / Foreigner',viajeroDesc:'I want to meet Argentinians — Free to register',yaTenes:'Already have an account?',entrar:'Log in',tusDatos:'Your details',nombre:'First name',apellido:'Last name',email:'Email',contrasena:'Password',minimo:'Minimum 6 characters',telefono:'Phone',ciudad:'City',ciudadPlaceholder:'Buenos Aires, Mendoza...',pais:'Country of residence',paisPlaceholder:'Spain, Italy, USA...',atras:'Back',siguiente:'Next',registrarGratis:'Register for free',creando:'Creating...',gratis:'Registration is free. You only pay when you choose a host.',cobrar:'How do you want to get paid?',mp:'Mercado Pago',mpDesc:'Recommended for Argentina',banco:'Bank account',bancoDesc:'CBU or alias',mpEmail:'Mercado Pago email or phone',cbu:'CBU or alias',crearCuenta:'Create account',creandoCuenta:'Creating account...',emailMsg:'We have sent you a confirmation email. It may land in your spam folder.'},
  pt:{titulo:'Entre no Argentalk',soy:'Sou...',anfitrionTitulo:'Anfitrião argentino',anfitrionDesc:'Quero compartilhar minha cultura e ganhar dinheiro',viajeroTitulo:'Viajante / Estrangeiro',viajeroDesc:'Quero conhecer argentinos — Cadastro gratuito',yaTenes:'Já tem conta?',entrar:'Entrar',tusDatos:'Seus dados',nombre:'Nome',apellido:'Sobrenome',email:'Email',contrasena:'Senha',minimo:'Mínimo 6 caracteres',telefono:'Telefone',ciudad:'Cidade',ciudadPlaceholder:'Buenos Aires, Mendoza...',pais:'País de residência',paisPlaceholder:'Espanha, Itália, EUA...',atras:'Voltar',siguiente:'Próximo',registrarGratis:'Cadastrar grátis',creando:'Criando...',gratis:'O cadastro é gratuito. Você só paga quando escolhe um anfitrião.',cobrar:'Como quer receber?',mp:'Mercado Pago',mpDesc:'Recomendado para Argentina',banco:'Conta bancária',bancoDesc:'CBU ou alias',mpEmail:'Email ou telefone do Mercado Pago',cbu:'CBU ou alias',crearCuenta:'Criar conta',creandoCuenta:'Criando conta...',emailMsg:'Enviamos um email de confirmação. Pode chegar na caixa de spam.'},
  fr:{titulo:'Rejoindre Argentalk',soy:'Je suis...',anfitrionTitulo:'Hôte argentin',anfitrionDesc:'Je veux partager ma culture et gagner de l\'argent',viajeroTitulo:'Voyageur / Étranger',viajeroDesc:'Je veux rencontrer des Argentins — Inscription gratuite',yaTenes:'Vous avez déjà un compte?',entrar:'Se connecter',tusDatos:'Vos informations',nombre:'Prénom',apellido:'Nom',email:'Email',contrasena:'Mot de passe',minimo:'Minimum 6 caractères',telefono:'Téléphone',ciudad:'Ville',ciudadPlaceholder:'Buenos Aires, Mendoza...',pais:'Pays de résidence',paisPlaceholder:'Espagne, Italie, USA...',atras:'Retour',siguiente:'Suivant',registrarGratis:'S\'inscrire gratuitement',creando:'Création...',gratis:'L\'inscription est gratuite.',cobrar:'Comment voulez-vous être payé?',mp:'Mercado Pago',mpDesc:'Recommandé pour l\'Argentine',banco:'Compte bancaire',bancoDesc:'CBU ou alias',mpEmail:'Email ou téléphone Mercado Pago',cbu:'CBU ou alias',crearCuenta:'Créer un compte',creandoCuenta:'Création...',emailMsg:'Nous vous avons envoyé un email de confirmation. Il peut arriver dans vos spams.'},
  it:{titulo:'Unisciti ad Argentalk',soy:'Sono...',anfitrionTitulo:'Host argentino',anfitrionDesc:'Voglio condividere la mia cultura e guadagnare',viajeroTitulo:'Viaggiatore / Straniero',viajeroDesc:'Voglio conoscere argentini — Registrazione gratuita',yaTenes:'Hai già un account?',entrar:'Accedi',tusDatos:'I tuoi dati',nombre:'Nome',apellido:'Cognome',email:'Email',contrasena:'Password',minimo:'Minimo 6 caratteri',telefono:'Telefono',ciudad:'Città',ciudadPlaceholder:'Buenos Aires, Mendoza...',pais:'Paese di residenza',paisPlaceholder:'Spagna, Italia, USA...',atras:'Indietro',siguiente:'Avanti',registrarGratis:'Registrati gratis',creando:'Creazione...',gratis:'La registrazione è gratuita.',cobrar:'Come vuoi essere pagato?',mp:'Mercado Pago',mpDesc:'Consigliato per Argentina',banco:'Conto bancario',bancoDesc:'CBU o alias',mpEmail:'Email o telefono Mercado Pago',cbu:'CBU o alias',crearCuenta:'Crea account',creandoCuenta:'Creazione...',emailMsg:'Ti abbiamo inviato un\'email di conferma. Potrebbe finire nello spam.'},
  de:{titulo:'Argentalk beitreten',soy:'Ich bin...',anfitrionTitulo:'Argentinischer Gastgeber',anfitrionDesc:'Ich möchte meine Kultur teilen und Geld verdienen',viajeroTitulo:'Reisender / Ausländer',viajeroDesc:'Ich möchte Argentinier kennenlernen — Kostenlos',yaTenes:'Haben Sie bereits ein Konto?',entrar:'Anmelden',tusDatos:'Ihre Daten',nombre:'Vorname',apellido:'Nachname',email:'E-Mail',contrasena:'Passwort',minimo:'Mindestens 6 Zeichen',telefono:'Telefon',ciudad:'Stadt',ciudadPlaceholder:'Buenos Aires, Mendoza...',pais:'Wohnsitzland',paisPlaceholder:'Spanien, Italien, USA...',atras:'Zurück',siguiente:'Weiter',registrarGratis:'Kostenlos registrieren',creando:'Erstellen...',gratis:'Die Registrierung ist kostenlos.',cobrar:'Wie möchten Sie bezahlt werden?',mp:'Mercado Pago',mpDesc:'Empfohlen für Argentinien',banco:'Bankkonto',bancoDesc:'CBU oder Alias',mpEmail:'Mercado Pago E-Mail oder Telefon',cbu:'CBU oder Alias',crearCuenta:'Konto erstellen',creandoCuenta:'Konto wird erstellt...',emailMsg:'Wir haben Ihnen eine Bestätigungs-E-Mail gesendet. Sie könnte im Spam-Ordner landen.'},
  zh:{titulo:'加入Argentalk',soy:'我是...',anfitrionTitulo:'阿根廷主人',anfitrionDesc:'我想分享文化并赚取额外收入',viajeroTitulo:'旅行者/外国人',viajeroDesc:'我想认识阿根廷人 — 免费注册',yaTenes:'已有账户?',entrar:'登录',tusDatos:'您的信息',nombre:'名字',apellido:'姓氏',email:'电子邮件',contrasena:'密码',minimo:'最少6个字符',telefono:'电话',ciudad:'城市',ciudadPlaceholder:'布宜诺斯艾利斯...',pais:'居住国',paisPlaceholder:'西班牙，意大利，美国...',atras:'返回',siguiente:'下一步',registrarGratis:'免费注册',creando:'创建中...',gratis:'注册是免费的。',cobrar:'您想如何收款?',mp:'Mercado Pago',mpDesc:'推荐用于阿根廷',banco:'银行账户',bancoDesc:'CBU或别名',mpEmail:'Mercado Pago邮箱或电话',cbu:'CBU或别名',crearCuenta:'创建账户',creandoCuenta:'创建中...',emailMsg:'我们已向您发送确认邮件。可能会进入垃圾邮件。'},
  ru:{titulo:'Присоединиться к Argentalk',soy:'Я...',anfitrionTitulo:'Аргентинский хозяин',anfitrionDesc:'Хочу делиться культурой и зарабатывать',viajeroTitulo:'Путешественник / Иностранец',viajeroDesc:'Хочу познакомиться с аргентинцами — Бесплатно',yaTenes:'Уже есть аккаунт?',entrar:'Войти',tusDatos:'Ваши данные',nombre:'Имя',apellido:'Фамилия',email:'Эл. почта',contrasena:'Пароль',minimo:'Минимум 6 символов',telefono:'Телефон',ciudad:'Город',ciudadPlaceholder:'Буэнос-Айрес...',pais:'Страна проживания',paisPlaceholder:'Испания, Италия, США...',atras:'Назад',siguiente:'Далее',registrarGratis:'Зарегистрироваться бесплатно',creando:'Создание...',gratis:'Регистрация бесплатна.',cobrar:'Как получать оплату?',mp:'Mercado Pago',mpDesc:'Рекомендуется для Аргентины',banco:'Банковский счёт',bancoDesc:'CBU или псевдоним',mpEmail:'Email или телефон Mercado Pago',cbu:'CBU или псевдоним',crearCuenta:'Создать аккаунт',creandoCuenta:'Создание...',emailMsg:'Мы отправили вам письмо с подтверждением. Оно может попасть в спам.'},
};
    ...
    <>
      ...
      <div className="container">
        <div className="card" style={{textAlign:'center'}}>
          ...
          <h1 style={{marginBottom:12}}>Argentalk</h1>
          <div style={{background:'#f0fff4',borderRadius:12,padding:16,marginBottom:16,fontSize:15,color:'#065f46',lineHeight:1.6}}>
            📧 {t.emailMsg}
          </div>
          <div style={{fontSize:13,color:'#888'}}>Redirigiendo...</div>
        </div>
      </div>
    </>
  );
