...
const CULTURAS = {
  mate: {
    ...
    fr: { titulo:'Le Mate', sub:"La boisson nationale de l'Argentine", secciones:[{t:"Qu'est-ce que le mate?",p:"Le mate est une infusion de feuilles de yerba mate. C'est un rituel social qui réunit les gens, partagé en cercle de main en main."},{t:'Les règles',p:"Le cebador remplit et passe. Ne remerciez pas avant d'avoir fini. Merci signifie que vous n'en voulez plus. Ne bougez jamais la bombilla."}], cta:'Vous voulez apprendre à boire du mate avec un vrai Argentin?'},
    ...
    ru: { titulo:'Мате', sub:'Национальный напиток Аргентины', secciones:[{t:'Что такое мате?',p:'Мате — настой из листьев йерба мате. Это социальный ритуал объединяющий людей передаваемый по кругу из рук в руки.'},{t:'Правила',p:'Себадор наполняет и передает. Не благодарите до конца. Спасибо значит больше не хотите. Никогда не двигайте бомбилью.'}], cta:'Хотите научиться пить мате с настоящим аргентинцем?'},
  },
  truco: {
    icon: '🃏',
    es: { titulo:'El Truco', sub:'El juego de cartas más popular de Argentina', secciones:[{t:'¿Qué es el Truco?',p:'El Truco es un juego de cartas español muy popular en Argentina, Uruguay y Paraguay. Se juega con una baraja española de 40 cartas. Es un juego de estrategia, bluff y mucha picardía.'},{t:'Las cartas más importantes',p:'1 de Espadas, 1 de Bastos, 7 de Espadas y 7 de Oros son las más poderosas del juego.'}], cta:'¿Querés aprender a jugar al Truco con un argentino real?'},
    en: { titulo:'Truco', sub:"Argentina's most popular card game", secciones:[{t:'What is Truco?',p:"Truco is a Spanish card game very popular in Argentina, Uruguay and Paraguay. It's played with a Spanish deck of 40 cards. It's a game of strategy, bluffing and cunning."},{t:'The most important cards',p:'Ace of Swords, Ace of Clubs, 7 of Swords and 7 of Coins are the most powerful cards.'}], cta:'Want to learn to play Truco with a real Argentinian?'},
...
const UI = {
  es:{btn:'Buscar anfitriones'}, en:{btn:'Find hosts'}, pt:{btn:'Encontrar anfitriões'},
  fr:{btn:'Trouver des hôtes'}, it:{btn:'Trova host'}, de:{btn:'Gastgeber finden'},
  zh:{btn:'寻找主人'}, ru:{btn:'Найти хозяина'},
};
